...
*/
    ...
    void priceCartProductsSameTypeIsCorrectCalculated() {
        ...
        // Assert (Проверка утверждения)
        assertThat(cart.getTotalPrice()).isEqualTo(170 * 2 + 250 * 2 + 200);
    }
    ...
    void whenChangingCartCostRecalculationIsCalled() {
        ...
        // Assert (Проверка утверждения)
        assertThat(cart.getTotalPrice()).isEqualTo(170 * 2);
    }
    ...
    void quantityProductsStoreChanging() {
        ...
        cart.addProductToCartByID(1);
        // Assert (Проверка утверждения)
        assertThat(shop.getProductsShop().get(0).getQuantity()).isEqualTo(8); //0,1,2...
    }
    ...
    void lastProductsDisappearFromStore() {
        ...
        // Assert (Проверка утверждения)
        assertThat(cart.cartItems.get(0).getQuantity()).isEqualTo(quantity);
    ...
    void deletedProductIsReturnedToShop() {
        ...
        cart.removeProductByID(1);
        // Assert (Проверка утверждения)
        assertEquals(currentQuantity + 1, shop.getProductsShop().get(0).getQuantity());
    }
